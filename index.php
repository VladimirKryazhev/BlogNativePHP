...
$articles = mysqli_query($connect, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT 4");
            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
<?php 
$articles = mysqli_query($connect, "SELECT * FROM `articles` WHERE `categorie_id` = 5 ORDER BY `id` DESC LIMIT 10");
            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
<?php 
$articles = mysqli_query($connect, "SELECT * FROM `articles` WHERE `categorie_id` = 1 ORDER BY `id` DESC LIMIT 10");
