...
if ($page <=1 || $page > $total_pages) 
{
  ...
  //1страница (4*1)-4 = 0 сдвиг offset
  //2страница (4*2)-4 = 4 сдвиг offset
  //3страница (4*3)-4 = 8 сдвиг offset

$articles = mysqli_query($connect, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT $offset,$per_page");


$arcticles_exist = true;
if (mysqli_num_rows($articles) <=0 ) 
{
  echo 'Нет статей';
  $arcticles_exist = false;
}
